    ...
    public static class ApplicationExtension
    {
        ...
        public static void ConfigureAndCheckMigration(this IApplicationBuilder app)
        {
            RepositoryContext context = app
                ...
                .CreateScope()
                .ServiceProvider
                .GetRequiredService<RepositoryContext>(); // context nesnesini uygulamadan aldık
                                                          // ama newleyip de yapabilirdir(gereksiz zaten uygulamada var)
